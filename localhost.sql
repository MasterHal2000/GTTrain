...
--
-- Database: `cs4400_Team_21`
--
CREATE DATABASE `cs4400_Team_21` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cs4400_Team_21`;
...
-- in use(#1142 - SHOW VIEW command denied to user 'cs4400_Team_21'@'localhost' for table 'Tickets')
--
...
(NULL, 'cs4400_Team_21', 'Customer', 'Username', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Customer', 'Email', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'UNI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Customer', 'IsStudent', 3, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Manager', 'Username', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'CardNum', 1, NULL, 'NO', 'char', 16, 16, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(16)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'CVV', 2, NULL, 'NO', 'char', 3, 3, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(3)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'ExpirationDate', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'NameOnCard', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'Username', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 'ReserveID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 'IsCancelled', 2, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 'Username', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 'CardNum', 4, '0', 'NO', 'char', 16, 16, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(16)', 'MUL', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'ReserveID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'TrainNum', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'Class', 3, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'DepartureDate', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'PassengerName', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'NumOfBaggage', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'DepartFrom', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'ArriveAt', 8, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'UpdateTimes', 9, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Review', 'ReviewNum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Review', 'Comment', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Review', 'Rating', 3, NULL, 'NO', 'varchar', 9, 9, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(9)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Review', 'Username', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Review', 'TrainNum', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Station', 'StationName', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Station', 'Location', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Stop', 'TrainNum', 1, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Stop', 'StationName', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Stop', 'ArrivalTime', 3, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Stop', 'DepartureTime', 4, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'SystemInfo', 'MaxNumOfBaggage', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'SystemInfo', 'NumOfFreeBaggage', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'SystemInfo', 'StudentDiscount', 3, NULL, 'NO', 'decimal', NULL, NULL, 3, 2, NULL, NULL, 'decimal(3,2)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'SystemInfo', 'ChangeFee', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'ReserveID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'TrainNum', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'Class', 3, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'DepartureDate', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'PassengerName', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'NumOfBaggage', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'DepartFrom', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'ArriveAt', 8, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'UpdateTimes', 9, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'TrainRoute', 'TrainNum', 1, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'TrainRoute', 'FstClassPrice', 2, NULL, 'NO', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'TrainRoute', 'SndClassPrice', 3, NULL, 'NO', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'User', 'Username', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update', ''),
(NULL, 'cs4400_Team_21', 'User', 'Password', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update', '');
...
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Customer', 'Username', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'Email', NULL, 'cs4400_Team_21', 'Customer', 'Email', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Manager', 'Username', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'PaymentInfo', 'CardNum', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Reservation', 'ReserveID', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Reserve', 'ReserveID', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Reserve', 'TrainNum', 2, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Review', 'ReviewNum', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Station', 'StationName', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Stop', 'TrainNum', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'Stop', 'StationName', 2, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'SystemInfo', 'MaxNumOfBaggage', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'TrainRoute', 'TrainNum', 1, NULL, NULL, NULL, NULL),
(NULL, 'cs4400_Team_21', 'PRIMARY', NULL, 'cs4400_Team_21', 'User', 'Username', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'cs4400_Team_21', 'Customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23, 31, 752, 281474976710655, 3072, 24, '2016-04-13 19:26:38', '2016-04-24 17:39:32', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Manager', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 20, 100, 281474976710655, 2048, 0, '2016-04-13 19:26:46', '2016-04-15 16:43:51', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'PaymentInfo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 59, 2072, 281474976710655, 3072, 596, '2016-04-13 19:27:03', '2016-04-24 18:11:41', '2016-04-24 05:22:11', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Reservation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 75, 31, 2396, 281474976710655, 4096, 0, '2016-04-24 15:01:05', '2016-04-24 18:11:06', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Reserve', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 87, 69, 6028, 281474976710655, 5120, 0, '2016-04-23 20:51:39', '2016-04-24 18:11:30', '2016-04-24 05:49:43', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Review', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23, 53, 1224, 281474976710655, 4096, 0, '2016-04-16 17:34:40', '2016-04-24 18:03:44', '2016-04-24 05:19:30', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Station', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 47, 472, 281474976710655, 2048, 0, '2016-04-13 19:27:23', '2016-04-24 05:59:08', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Stop', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 32, 44, 2256, 281474976710655, 5120, 844, '2016-04-15 20:51:19', '2016-04-24 10:46:21', '2016-04-24 05:45:25', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'SystemInfo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 15, 30, 4222124650659839, 2048, 15, '2016-04-13 19:27:36', '2016-04-15 17:22:14', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'TrainRoute', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 20, 160, 281474976710655, 2048, 0, '2016-04-24 05:50:07', '2016-04-24 18:06:00', NULL, NULL, '', '', NULL),
=======
...
(NULL, 'cs4400_Team_21', 'Customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23, 31, 752, 281474976710655, 3072, 24, '2016-04-13 19:26:38', '2016-04-24 17:39:32', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Manager', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 20, 100, 281474976710655, 2048, 0, '2016-04-13 19:26:46', '2016-04-15 16:43:51', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'PaymentInfo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 59, 2072, 281474976710655, 3072, 596, '2016-04-13 19:27:03', '2016-04-24 17:40:27', '2016-04-24 05:22:11', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Reservation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 57, 31, 1820, 281474976710655, 4096, 0, '2016-04-24 15:01:05', '2016-04-24 17:52:10', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Reserve', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 69, 70, 5076, 281474976710655, 3072, 220, '2016-04-23 20:51:39', '2016-04-24 17:34:44', '2016-04-24 05:49:43', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Review', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23, 52, 1204, 281474976710655, 4096, 0, '2016-04-16 17:34:40', '2016-04-24 17:22:21', '2016-04-24 05:19:30', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Station', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 47, 472, 281474976710655, 2048, 0, '2016-04-13 19:27:23', '2016-04-24 05:59:08', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'Stop', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 32, 44, 2256, 281474976710655, 5120, 844, '2016-04-15 20:51:19', '2016-04-24 10:46:21', '2016-04-24 05:45:25', NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'SystemInfo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 15, 30, 4222124650659839, 2048, 15, '2016-04-13 19:27:36', '2016-04-15 17:22:14', NULL, NULL, '', '', NULL),
(NULL, 'cs4400_Team_21', 'TrainRoute', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 20, 160, 281474976710655, 2048, 0, '2016-04-24 05:50:07', '2016-04-24 17:49:43', NULL, NULL, '', '', NULL),
>>>>>>> dbd27bf5854a988c4273e93faf27ff65b19285a3
(NULL, 'cs4400_Team_21', 'User', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 29, 26, 880, 281474976710655, 2048, 100, '2016-04-13 19:26:16', '2016-04-24 17:06:14', NULL, NULL, '', '', NULL);
...
<<<<<<< HEAD
(341334, 'cs4400_Team_21', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(340509, 'cs4400_Team_21', 'lawn-128-61-74-195.lawn.gatech.edu:50262', 'cs4400_Team_21', 'Sleep', 253, '', NULL),
(340315, 'cs4400_Team_21', 'lawn-128-61-62-243.lawn.gatech.edu:58705', 'cs4400_Team_21', 'Sleep', 335, '', NULL),
(338644, 'cs4400_Team_21', 'lawn-128-61-74-195.lawn.gatech.edu:50024', 'cs4400_Team_21', 'Sleep', 858, '', NULL);
=======
(337697, 'cs4400_Team_21', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(333437, 'cs4400_Team_21', 'lawn-128-61-115-162.lawn.gatech.edu:64169', 'cs4400_Team_21', 'Sleep', 871, '', NULL);
>>>>>>> dbd27bf5854a988c4273e93faf27ff65b19285a3
...
(NULL, 'cs4400_Team_21', 'latin1', 'latin1_swedish_ci', NULL);
...
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'SELECT', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'INSERT', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'UPDATE', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'DELETE', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'CREATE', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'DROP', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'ALTER', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'LOCK TABLES', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'EXECUTE', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'CREATE VIEW', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'CREATE ROUTINE', 'NO'),
('''cs4400_Team_21''@''%''', NULL, 'cs4400_Team_21', 'ALTER ROUTINE', 'NO');
...
(NULL, 'cs4400_Team_21', 'Customer', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'Username', 'A', 23, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Customer', 0, 'cs4400_Team_21', 'Email', 1, 'Email', 'A', 23, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Manager', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'Username', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'CardNum', 'A', 25, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 1, 'cs4400_Team_21', 'Username', 1, 'Username', 'A', 12, NULL, NULL, '', 'BTREE', ''),
<<<<<<< HEAD
(NULL, 'cs4400_Team_21', 'Reservation', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'ReserveID', 'A', 75, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 1, 'cs4400_Team_21', 'Username', 1, 'Username', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 1, 'cs4400_Team_21', 'CardNum', 1, 'CardNum', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'ReserveID', 'A', 87, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 0, 'cs4400_Team_21', 'PRIMARY', 2, 'TrainNum', 'A', 87, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 1, 'cs4400_Team_21', 'TrainNum', 1, 'TrainNum', 'A', 14, NULL, NULL, '', 'BTREE', ''),
=======
(NULL, 'cs4400_Team_21', 'Reservation', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'ReserveID', 'A', 57, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 1, 'cs4400_Team_21', 'Username', 1, 'Username', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 1, 'cs4400_Team_21', 'CardNum', 1, 'CardNum', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'ReserveID', 'A', 69, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 0, 'cs4400_Team_21', 'PRIMARY', 2, 'TrainNum', 'A', 69, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 1, 'cs4400_Team_21', 'TrainNum', 1, 'TrainNum', 'A', 11, NULL, NULL, '', 'BTREE', ''),
>>>>>>> dbd27bf5854a988c4273e93faf27ff65b19285a3
(NULL, 'cs4400_Team_21', 'Review', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'ReviewNum', 'A', 23, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Review', 1, 'cs4400_Team_21', 'Username', 1, 'Username', 'A', 23, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Review', 1, 'cs4400_Team_21', 'TrainNum', 1, 'TrainNum', 'A', 11, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Station', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'StationName', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Stop', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'TrainNum', 'A', 8, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Stop', 0, 'cs4400_Team_21', 'PRIMARY', 2, 'StationName', 'A', 32, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'Stop', 1, 'cs4400_Team_21', 'StationName', 1, 'StationName', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'SystemInfo', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'MaxNumOfBaggage', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'TrainRoute', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'TrainNum', 'A', 8, NULL, NULL, '', 'BTREE', ''),
(NULL, 'cs4400_Team_21', 'User', 0, 'cs4400_Team_21', 'PRIMARY', 1, 'Username', 'A', 29, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'cs4400_Team_21', 'Customer', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 23, 31, 752, 281474976710655, 3072, 24, NULL, '2016-04-13 19:26:38', '2016-04-24 17:39:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Manager', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 20, 100, 281474976710655, 2048, 0, NULL, '2016-04-13 19:26:46', '2016-04-15 16:43:51', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 25, 59, 2072, 281474976710655, 3072, 596, NULL, '2016-04-13 19:27:03', '2016-04-24 18:11:41', '2016-04-24 05:22:11', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 75, 31, 2396, 281474976710655, 4096, 0, 76, '2016-04-24 15:01:05', '2016-04-24 18:11:06', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 87, 69, 6028, 281474976710655, 5120, 0, NULL, '2016-04-23 20:51:39', '2016-04-24 18:11:30', '2016-04-24 05:49:43', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Review', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 23, 53, 1224, 281474976710655, 4096, 0, 33, '2016-04-16 17:34:40', '2016-04-24 18:03:44', '2016-04-24 05:19:30', 'latin1_swedish_ci', NULL, '', ''),
=======
...
(NULL, 'cs4400_Team_21', 'Customer', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 23, 31, 752, 281474976710655, 3072, 24, NULL, '2016-04-13 19:26:38', '2016-04-24 17:39:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Manager', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 20, 100, 281474976710655, 2048, 0, NULL, '2016-04-13 19:26:46', '2016-04-15 16:43:51', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'PaymentInfo', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 25, 59, 2072, 281474976710655, 3072, 596, NULL, '2016-04-13 19:27:03', '2016-04-24 17:40:27', '2016-04-24 05:22:11', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Reservation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 57, 31, 1820, 281474976710655, 4096, 0, 58, '2016-04-24 15:01:05', '2016-04-24 17:52:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Reserve', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 69, 70, 5076, 281474976710655, 3072, 220, NULL, '2016-04-23 20:51:39', '2016-04-24 17:34:44', '2016-04-24 05:49:43', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Review', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 23, 52, 1204, 281474976710655, 4096, 0, 33, '2016-04-16 17:34:40', '2016-04-24 17:22:21', '2016-04-24 05:19:30', 'latin1_swedish_ci', NULL, '', ''),
>>>>>>> dbd27bf5854a988c4273e93faf27ff65b19285a3
(NULL, 'cs4400_Team_21', 'Station', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 47, 472, 281474976710655, 2048, 0, NULL, '2016-04-13 19:27:23', '2016-04-24 05:59:08', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Stop', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 32, 44, 2256, 281474976710655, 5120, 844, NULL, '2016-04-15 20:51:19', '2016-04-24 10:46:21', '2016-04-24 05:45:25', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'SystemInfo', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 15, 30, 4222124650659839, 2048, 15, NULL, '2016-04-13 19:27:36', '2016-04-15 17:22:14', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'cs4400_Team_21', 'Tickets', 'VIEW', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'VIEW'),
<<<<<<< HEAD
(NULL, 'cs4400_Team_21', 'TrainRoute', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 20, 160, 281474976710655, 2048, 0, NULL, '2016-04-24 05:50:07', '2016-04-24 18:06:00', NULL, 'latin1_swedish_ci', NULL, '', ''),
=======
(NULL, 'cs4400_Team_21', 'TrainRoute', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 20, 160, 281474976710655, 2048, 0, NULL, '2016-04-24 05:50:07', '2016-04-24 17:49:43', NULL, 'latin1_swedish_ci', NULL, '', ''),
>>>>>>> dbd27bf5854a988c4273e93faf27ff65b19285a3
(NULL, 'cs4400_Team_21', 'User', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 29, 26, 880, 281474976710655, 2048, 100, NULL, '2016-04-13 19:26:16', '2016-04-24 17:06:14', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Customer', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'Email', 'cs4400_Team_21', 'Customer', 'UNIQUE'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Manager', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'PaymentInfo', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Reservation', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Reserve', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Review', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Station', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'Stop', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'SystemInfo', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'TrainRoute', 'PRIMARY KEY'),
(NULL, 'cs4400_Team_21', 'PRIMARY', 'cs4400_Team_21', 'User', 'PRIMARY KEY');
...
(NULL, 'cs4400_Team_21', 'Tickets', 'select `cs4400_Team_21`.`Reserve`.`ReserveID` AS `ReserveID`,`cs4400_Team_21`.`Reserve`.`TrainNum` AS `TrainNum`,`cs4400_Team_21`.`Reserve`.`Class` AS `Class`,`cs4400_Team_21`.`Reserve`.`DepartureDate` AS `DepartureDate`,`cs4400_Team_21`.`Reserve`.`PassengerName` AS `PassengerName`,`cs4400_Team_21`.`Reserve`.`NumOfBaggage` AS `NumOfBaggage`,`cs4400_Team_21`.`Reserve`.`DepartFrom` AS `DepartFrom`,`cs4400_Team_21`.`Reserve`.`ArriveAt` AS `ArriveAt`,`cs4400_Team_21`.`Reserve`.`UpdateTimes` AS `UpdateTimes` from `cs4400_Team_21`.`Reserve` where (`cs4400_Team_21`.`Reserve`.`ReserveID` = ''1'')', 'NONE', 'YES', 'cs4400_Team_21@%', 'DEFINER', 'utf8', 'utf8_unicode_ci');
